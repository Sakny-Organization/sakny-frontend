...
const SkeletonLoader = ({ width = 'w-full', height = 'h-4', circle = false, className = '', }) => {
...
// Skeleton for card
export const CardSkeleton = () => (<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 space-y-4">
...
export const ProfileSkeleton = () => (<div className="space-y-4">
