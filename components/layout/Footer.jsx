    ...
    return (
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }}>
          ...
          <div className="relative">
            <input className="w-full bg-card border border-borderLight rounded-lg px-4 py-3 text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="Email address" type="email"/>
      ...
      {/* Copyright */}
      <motion.div 
        className="max-w-[1400px] mx-auto mt-16 pt-8 border-t border-borderLight flex justify-center text-xs font-bold text-muted uppercase tracking-widest"
        initial={{ opacity: 0 }} 
