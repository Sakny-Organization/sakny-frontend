    ...
    return (<div className="flex min-h-screen w-full bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-black flex-col justify-between p-12 lg:p-16 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" alt="Modern Interior" className="w-full h-full object-cover opacity-60"/>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-1">
              ...
              <Input name="email" type="text" value={email} onChange={handleEmailChange} error={errors.email} required placeholder="hello@gmail.com or 01000000000" className="bg-gray-50 border-gray-200 focus:bg-white transition-all h-12" noLabel/>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <button type="button" className="absolute right-4 top-[14px] text-gray-400 hover:text-black transition-colors" onClick={() => setShowPassword(!showPassword)}>
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" id="stay-logged-in" className="w-4 h-4 rounded border-gray-300 text-black focus:ring-black"/>
