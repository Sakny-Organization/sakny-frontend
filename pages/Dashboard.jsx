          ...
          <motion.div className="space-y-6" variants={itemVariants}>
            ...
            <motion.div className="bg-white rounded-lg p-6 shadow-lg" whileHover={{ y: -4 }} transition={{ duration: 0.3 }}>
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <motion.li className="flex items-start gap-2" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6, duration: 0.3 }}>
                  <span className="text-black">•</span>
                  <span>Add photos to get 5x more views</span>
                </motion.li>
                <motion.li className="flex items-start gap-2" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.7, duration: 0.3 }}>
                  <span className="text-black">•</span>
                  <span>Complete all sections for better matches</span>
                </motion.li>
                <motion.li className="flex items-start gap-2" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8, duration: 0.3 }}>
                  <span className="text-black">•</span>
